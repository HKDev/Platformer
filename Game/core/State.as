...
///////////////////////////////////////////////////////// [ CLASS ] ////////////////////////////////////////////////////////////////////////////
	...
	public class State extends FlxState {
		...
		// blur testing - attaching to player when player gains momentum during movement. this could be an enhancement feature in game.
		private var blurFX:BlurFX;
...
/* --------------------------- */// Create State
		...
		override public function create():void {			
			...
			/* --------------------------- */// Blur we are going to attach to Player if we ever get it working. 
			blurFX = FlxSpecialFX.blur();
			blurEffect = blurFX.create(FlxG.worldBounds.width,FlxG.worldBounds.height, 2.5, 2.5, 1);
			blurFX.addSprite(player,true);
			add(blurEffect);
		...
		private function bulletTouchedMap(b:Bullet, m:FlxTilemap):void {
			...
			switch(tile) {
				...
				case 31:
					...
					break;
				case 49:
					m.setTile(b.x/16,b.y/16,0,true);
					breakTile(b);
					b.kill();
					break;
